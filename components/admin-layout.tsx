...
const adminNavItems = [
  ...
  { href: '/admin/subscriptions', label: 'Subscriptions & Payments', icon: CreditCard },
  { href: '/admin/products', label: 'Product Master', icon: Package },
  { href: '/admin/stock', label: 'Stock & Ledger', icon: Warehouse },
  { href: '/admin/invoices', label: 'Invoices & Parsing', icon: FileText },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-white border-b z-50 p-4">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-bold text-gray-900">ElectroTrack Admin</h1>
