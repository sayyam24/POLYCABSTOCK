...
export default function SubDistributorShipmentsPage() {
  ...
  const handleReceiveShipment = (shipmentId: string) => {
    router.push(`/sub-distributor/shipments/${shipmentId}/receive`)
  }

  const handleViewShipment = (shipmentId: string) => {
    router.push(`/sub-distributor/shipments/${shipmentId}`)
  }
