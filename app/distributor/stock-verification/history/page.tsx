...
export default function AdjustmentHistoryPage() {
  ...
  const filteredAdjustments = adjustments.filter(adj => {
    ...
    const matchesProduct = !filterProduct || adj.productId === filterProduct
    const matchesUser = !filterUser || adj.adjustedBy === filterUser
    const matchesReason = !filterReason || adj.reason === filterReason

    return matchesSearch && matchesDate && matchesProduct && matchesUser && matchesReason
  })
