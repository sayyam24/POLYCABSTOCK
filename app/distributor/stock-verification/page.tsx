...
import { Search, Check, X, Plus, Minus, AlertCircle } from 'lucide-react'
...
export default function StockVerificationPage() {
  ...
  const hasDifferences = verificationItems.some(item => item.difference !== 0)
